...
def plot_cv_regression(estimator: BaseEstimator, X_train, y_train, title=None) -> None:
    ...
    cv_pred = cross_val_predict(
        estimator.best_estimator_, X_train, y_train, cv=estimator.n_splits_
    )
...
def plot_predictions_regression(estimator: BaseEstimator, X, y, title=None):
    # Predict on the test set using the best estimator found by GridSearchCV
